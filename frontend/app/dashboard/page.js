...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // Real-time polling every 5 seconds for artisans
    let interval
    if (userProfile?.role === 'artisan') {
      ...
      {!isArtisan && (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">Browse Marketplace</h3>
                    <p className="text-sm text-muted-foreground">Explore handcrafted items</p>
                  </div>
            ...
            <Link href="/dashboard/new-arrivals">
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">New Arrivals</h3>
                    <p className="text-sm text-muted-foreground">Fresh items added recently</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
                </CardContent>
              </Card>
            ...
            <Link href="/dashboard/orders">
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">My Orders</h3>
                    <p className="text-sm text-muted-foreground">Track & rate purchases</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
                </CardContent>
              </Card>
            ...
            <Link href="/dashboard/wishlist">
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">My Wishlist</h3>
            ...
            <Link href="/dashboard/coupons">
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">My Coupons</h3>
                    <p className="text-sm text-muted-foreground">Available offers & deals</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
                </CardContent>
              </Card>
            ...
            <Link href="/dashboard/cart">
              <Card className="cursor-pointer hover:shadow-lg transition-all hover:border-primary/50 group h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-foreground font-display">Shopping Cart</h3>
                    <p className="text-sm text-muted-foreground">View & checkout items</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
                </CardContent>
              </Card>
